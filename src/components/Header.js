          ...
          <ul className={`flex flex-row ${HeaderStyles.navList}`}>
            ...
            <li><button onClick={() => { scrollTo("#features"); }} className="flex flex-row">
              <svg width="30" height="30" fill="#fff" viewBox="0 0 24 24" className={HeaderStyles.icon}>
                <path className={HeaderStyles.iconFill} stroke="#43aaef" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 4.75L13.75 10.25H19.25L14.75 13.75L16.25 19.25L12 15.75L7.75 19.25L9.25 13.75L4.75 10.25H10.25L12 4.75Z"/>
              </svg>
              <p>Features</p>
            </button></li>
            {/* About */}
            <li><button onClick={() => { scrollTo("#signUp"); }} className="flex flex-row">
              <svg width="30" height="30" fill="#fff" viewBox="0 0 24 24" className={HeaderStyles.icon}>
                <path className={HeaderStyles.iconFill} stroke="#43aaef" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M4.75 19.25L12 4.75L19.25 19.25L12 15.75L4.75 19.25Z"/>
                <path className={HeaderStyles.iconFill} stroke="#43aaef" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 15.5V12.75"/>              
              </svg>
              <p>Sign Up</p>
              {/* <svg width="30" height="30" fill="#fff" viewBox="0 0 24 24" className={HeaderStyles.icon}>
